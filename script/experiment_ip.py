...
from utils import true_values, compute_sample_size, get_vecAvecB, get_sketcher
...
if __name__ == "__main__":
    ...
    if mode == 'time':
        ...
        vecA, vecB = get_vecAvecB(overlap_ratio, outlier_fraction, mode, corr_r, nonZero_size=50000)
